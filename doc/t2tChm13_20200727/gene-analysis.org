...
% geneBoundsFromBigBlatPsl --nameField=geneSym  --geneType=lncRNA --geneType=protein_coding --maxSourceExpansion=1.5 --sourceAnnot=data/gencode.srcsizes.bed  ../../../../build/t2tChm13_20200727/gencodeBlat/gencode.bigBlatPsl data/gencode.lnc-prot.genes.bed
...
#+END_SRC
10k/centoGenes.bed	2344
10k/centoGenes.new.bed	1781
10k/centoGenes.new-pri.bed	1868
