...
selectById 1 CHM13.clusters.centro.bed 1 ../catGeneBounds/CHM13.no-user_filtered.gp  >CHM13.clusters.centro.gp
...
catClustersAddGo CHM13.clusters.centro.genes.tsv CHM13.clusters.centro.genes.go.tsv >&log&

# must do meg separate, as they were clustered independent
selectById -tsv 4 CHM13.meg.clusters.centro.bed 1 ../catGeneBounds/CHM13.meg.clusters.tsv >CHM13.meg.clusters.centro.tsv
selectById 1 CHM13.meg.clusters.centro.bed 1 ../catGeneBounds/CHM13.no-user_filtered.gp  >CHM13.meg.clusters.centro.gp
overlapSelect -statsOutput -overlapSimilarity=0.80 ../../../../build/t2tChm13_20200727/gencodeBlat/gencode.psl.gz CHM13.meg.clusters.centro.gp CHM13.meg.clusters.centro.blatover.stats

catClustersToGenes ../../../../build/t2tChm13_20200727/CAT/databases/GRCh38.db  ../catGeneBounds/CHM13.no-user_filtered.gp_info CHM13.meg.clusters.centro.blatover.stats CHM13.meg.clusters.centro.tsv CHM13.meg.clusters.centro.genes.tsv 
catClustersAddGo CHM13.meg.clusters.centro.genes.tsv CHM13.meg.clusters.centro.genes.go.tsv >&log&

tawk 'NR>1 && $8!=""{print $8}' CHM13.meg.clusters.centro.genes.go.tsv |tr ',' '\n' |sort -u >CHM13.meg.clusters.centro.hgncids
tawk 'NR>1 && $9!=""{print $9}' CHM13.meg.clusters.centro.genes.go.tsv |tr ',' '\n' |sort -u >CHM13.meg.clusters.centro.goid
