...
ln -s ../missingGenes/data/consensus.chm13.meg-lnc-prot.genes.bed 
ln -s ../../../../build/t2tChm13_20200727/cenRegions/t2t-chm13.20200727.cenRegions.bed.gz 

# centromere  genes
overlapSelect -overlapThreshold=1.0 -inCoordCols=0,1,2 t2t-chm13.20200727.cenRegions.bed.gz consensus.chm13.meg-lnc-prot.genes.bed  meg-lnc-prot.centro.genes.bed 

# centromere genes in unique regions
overlapSelect -overlapThreshold=0.8 -inCoordCols=0,1,2 combined.uniq.bed   meg-lnc-prot.centro.genes.bed   meg-lnc-prot.centro.uniq.genes.bed 

consensus.chm13.meg-lnc-prot.genes.bed	33047
meg-lnc-prot.centro.genes.bed	791
meg-lnc-prot.centro.uniq.genes.bed	17
