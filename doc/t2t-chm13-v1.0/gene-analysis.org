...
# liftOff for stats, name2 has the transcriptId, and drop chrMT
bigGenePredToGenePred /cluster/home/markd/compbio/nanopore/projs/t2t-chm13/build/t2tChm13_20200727/liftOff/liftOffGenes.all.bigGenePred stdout | tawk '$2=="chrMT"{next} {$1=$12; print}' | genePredToBed stdin stdout | geneBoundsForGencodeBed --geneType=protein_coding --geneType=lncRNA data/gencodeV35.db /dev/stdin --idTsv=data/liftoff-transcripts.tsv --filteredBed=data/liftoff-trans.bed data/liftoff-genes.bed
